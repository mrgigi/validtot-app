...
```bash
git remote add encore encore://validtot-app-5ski
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/validtot-app-5ski/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/validtot-app-5ski/settings/integrations/github)
