...
export default function CreatePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (formData.optionAText.length > 24 || formData.optionBText.length > 24) {
      toast.error('Option text must be 24 characters or less');
      return;
    }

    if (formData.optionCText && formData.optionCText.length > 24) {
      toast.error('Option text must be 24 characters or less');
      return;
    }
